...
namespace AutoReservation.UI.ViewModels
{
    public class AutoViewModel : INotifyPropertyChanged
    {
        ...
        // public bool HasBasistarif => SelectedAuto?.Typ == AutoTyp.Luxus;
        ...
        private void SortByMarke()
        {

        }

        private void SortByKlasse()
        {

        }

        private void SortByTarif()
        {
